...
/**
 *@brief                structura que guarda los datos de un alumno
 *@param apellidos      dato tipo caracter que almacena apellido 
 *@param nombres        dato tipo caracter que almacena nombre
 *@param documento      dato tipo caracter que almacena documento
 */
...
/**
*@brief                         Declaracion de varaibles globales
*@param ALUMNOS                 declaracion de un array
*@param CANTIDAD_ALUMNOS        declaracion de un entero para determinar el tamaño del array 
*/
